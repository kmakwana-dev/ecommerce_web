                        ...
                        <div class="row">
                            <div class="col-xl-4">
                                <div class="form-group">
                                    ...
                                    <x-image-uploader class="w-100" :imagePath="getImage(getFilePath('seo') . '/' . (isset($page->seo_content->image) ? $page->seo_content->image : ''), getFileSize('seo'))" :size="getFileSize('seo')" :required="false" name="image" />
                            ...
                            <div class="col-xl-8 mt-xl-0 mt-4">
                                <div class="form-group">
                                    ...
                                    <select name="keywords[]" class="form-control select2-auto-tokenize" multiple="multiple">
                                        @if (isset($page->seo_content->keywords))
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="social_title" value="{{ isset($page->seo_content->social_title) ? $page->seo_content->social_title : '' }}" />
                                </div>
                                <div class="form-group">
                                    <label>@lang('Social Description')</label>
                                    <textarea name="social_description" rows="3" class="form-control">{{ isset($page->seo_content->social_description) ? $page->seo_content->social_description : '' }}</textarea>
                                </div>
                                <div class="form-group">
