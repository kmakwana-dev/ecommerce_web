...
class ProcessController extends Controller {
    ...
    public static function process($deposit) {
        ...
        $data['cus_add1']     = isset($user->address) ? $user->address : '';
        $data['cus_city']     = isset($user->city) ? $user->city : "";
        $data['cus_state']    = isset($user->state) ? $user->state : "";
        $data['cus_postcode'] = isset($user->zip) ? $user->zip : '';
        $data['cus_country']  = isset($user->country_name) ? $user->country_name : "";

        $data['desc'] = "Payment via Aamarpay";
