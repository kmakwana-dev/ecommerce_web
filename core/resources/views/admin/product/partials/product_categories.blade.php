    ...
    <div class="card-body">
        ...
        @if (!blank($categories))
            ...
            <div class="categories-checkboxes">
                <x-category-checkbox :categories="$categories" :selected="@$product ? $product->categories->pluck('id')->toArray() : []" />
            </div>
        @else
            ...
            @if (@$product)
                setTimeout(() => {
                    ...
                    if (firstChecked) {
                        ...
                        const scrollToPosition = container.scrollTop + (itemTop - containerTop - 20);

                        container.scrollTo({
                            top: scrollToPosition,
                            behavior: 'smooth'
                        });
                        console.log('Scrolled to category:', firstChecked.value);
                    }
                }, 500);
            @endif
        })(jQuery);
