...
<head>
    ...
    <link rel="stylesheet" href="{{ asset(activeTemplate(true) . 'css/fontawesome.all.min.css') }}">
                            ...
                            <div class="col-12">
                                <div class="list--row">
                                    <div class="float-left">
                                        <h5 class="mb-2">@lang('Customer Details')</h5>
                                        <address>
                                            <ul>
                                        ...
                                        <div class="float-right">
                                            ...
                                            <address>
                                                <ul>
                                                    ...
                                                    <li>@lang('Address'): {{ $order->shipping_address->address }}</li>
                                                    <li>@lang('State'): {{ $order->shipping_address->state }}</li>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($order->orderDetail as $data)
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end">{{ showAmount($data->price * $data->quantity) }}
                                                </td>
                                            </tr>
                                        @endforeach
                                                    ...
                                                    <td width="50%" class="text-end">
                                                        @if ($order->deposit->method_code == 0)
                                                            <span data-bs-toggle="tooltip"
                                                                title="@lang('Cash On Delivery')">@lang('COD')</span>
                                                        @else
                                                            <span data-bs-toggle="tooltip"
                                                                title="{{ __(@$order->deposit->gateway->name) }}">{{ __(@$order->deposit->gateway->name) }}</span>
                                                        @endif
                                                    </td>
                                                </tr>
                                        ...
                                        <tbody>
                                            ...
                                            @if ($order->appliedCoupon)
                                                <tr>
                                                    ...
                                                    <td class="text-end">
                                                        {{ showAmount($order->appliedCoupon->amount) }}</td>
                                                </tr>
                                            @endif
                                            <tr>
                                                <td>(+) @lang('Shipping')</td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end fw-bold">{{ showAmount($order->total_amount) }}
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
