                    ...
                    <ul class="list-group">
                        @if ($deposit->user_id)
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                ...
                                <a href="{{ route('admin.users.detail', $deposit->user_id) }}" class="fw-bold"><span>@</span>{{ @$deposit->user->username }}</a>
                            </li>
                        @elseif($deposit->order && $deposit->order->guest_id)
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                @lang('Customer\'s Email')
                               <span class="fw-bold">
                                    {{ @$deposit->order->guest->email }}
                                </span>
                            </li>

                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                @lang('Customer\'s Mobile')
                               <span class="fw-bold">
                                    +{{ @$deposit->order->guest->dial_code }}{{ @$deposit->order->guest->mobile }}
                                </span>
                            </li>

                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                @lang('Customer\'s Country')
                               <span class="fw-bold">
                                    {{ @$deposit->order->guest->country_name }}
                                </span>
                            </li>
                        @endif
