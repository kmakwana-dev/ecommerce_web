...
trait SupportTicketManager
{
    ...
    public function replyTicket(Request $request, $id)
    {
        ...
        if ($this->userType == 'admin') {
            ...
            $userNotification->user_id = $ticket->user_id;
            $userNotification->title = 'Admin replied to ticket #' . $ticket->ticket;
            $userNotification->click_url = urlPath('ticket.view', $ticket->ticket);
