...
class ProductController extends Controller {
    ...
    public function productByCategory($slug) {
        ...
        // Also get sub-subcategories (ViserMart supports deeper levels)
        $subSubCategoryIds = Category::whereIn('parent_id', $categoryIds)->pluck('id')->toArray();
        $allCategoryIds = array_unique(array_merge($categoryIds, $subSubCategoryIds));

        $scope = function ($query) use ($allCategoryIds) {
